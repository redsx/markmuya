...
var index = require('./index-c04d3176.js');
require('path');
...
var eve$1 = index.createCommonjsModule(function (module) {
...
})(typeof window != "undefined" ? window : index.commonjsGlobal);
});

var snap_svg = index.createCommonjsModule(function (module, exports) {
// Snap.svg 0.5.0
//
...
}(window || index.commonjsGlobal, function (window, eve) {
...
var webfontloader = index.createCommonjsModule(function (module) {
...
"undefined" != typeof require && "undefined" != typeof exports && (exports.parser = parser, exports.Parser = parser.Parser, exports.parse = function () {
  ...
  args[1] || (console.log("Usage: " + args[0] + " FILE"), process.exit(1)); // var source = require("fs").readFileSync(require("path").normalize(args[1]), "utf8");
...
function wobble(x1, y1, x2, y2) {
  assert(_.all([x1, x2, y1, y2], _.isFinite), 'x1,x2,y1,y2 must be numeric'); // Wobble no more than 1/25 of the line length
...
if (typeof Raphael == 'undefined' && typeof snap_svg == 'undefined') {
