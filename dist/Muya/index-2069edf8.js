...
var index$1 = require('./index-a1e347dd.js');
...
var raphael_min = index$1.createCommonjsModule(function (module, exports) {
...
var drawLine = flowchart_functions.drawLine;
var checkLineIntersection = flowchart_functions.checkLineIntersection;

function Symbol$1(chart, options, symbol) {
  this.chart = chart;
...
Symbol$1.prototype.getAttr = function(attName) {
  if (!this.chart) {
    return undefined;
  }
...
Symbol$1.prototype.initialize = function() {
...
Symbol$1.prototype.getCenter = function() {
  return {x: this.getX() + this.width/2,
          y: this.getY() + this.height/2};
};

Symbol$1.prototype.getX = function() {
  return this.group.getBBox().x;
};

Symbol$1.prototype.getY = function() {
  return this.group.getBBox().y;
};

Symbol$1.prototype.shiftX = function(x) {
  this.group.transform('t' + (this.getX() + x) + ',' + this.getY());
};

Symbol$1.prototype.setX = function(x) {
  this.group.transform('t' + x + ',' + this.getY());
};

Symbol$1.prototype.shiftY = function(y) {
  this.group.transform('t' + this.getX() + ',' + (this.getY() + y));
};

Symbol$1.prototype.setY = function(y) {
  this.group.transform('t' + this.getX() + ',' + y);
};

Symbol$1.prototype.getTop = function() {
  var y = this.getY();
  var x = this.getX() + this.width/2;
  return {x: x, y: y};
};

Symbol$1.prototype.getBottom = function() {
  var y = this.getY() + this.height;
  var x = this.getX() + this.width/2;
  return {x: x, y: y};
};

Symbol$1.prototype.getLeft = function() {
  var y = this.getY() + this.group.getBBox().height/2;
  var x = this.getX();
  return {x: x, y: y};
};

Symbol$1.prototype.getRight = function() {
  var y = this.getY() + this.group.getBBox().height/2;
  var x = this.getX() + this.group.getBBox().width;
  return {x: x, y: y};
};

Symbol$1.prototype.render = function() {
  if (this.next) {
...
Symbol$1.prototype.renderLines = function() {
  if (this.next) {
...
Symbol$1.prototype.drawLineTo = function(symbol, text, origin) {
...
inherits$6(Condition, flowchart_symbol);
...
inherits$5(Parallel, flowchart_symbol);
...
function FlowChart$1(container, options) {
  options = options || {};

  this.paper = new raphael_min(container);
...
FlowChart$1.prototype.handle = function(symbol) {
...
FlowChart$1.prototype.startWith = function(symbol) {
  this.start = symbol;
  return this.handle(symbol);
};

FlowChart$1.prototype.render = function() {
  var maxWidth = 0,
    maxHeight = 0,
    i = 0,
    len = 0,
...
FlowChart$1.prototype.clean = function() {
  if (this.paper) {
...
var flowchart_chart = FlowChart$1;
...
inherits$4(Start, flowchart_symbol);
...
inherits$1(InputOutput, flowchart_symbol);
...
inherits(Subroutine, flowchart_symbol);
...
var index = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), flowchart_js, {
  'default': flowchart_js
}));

exports.index = index;
//# sourceMappingURL=index-2069edf8.js.map
